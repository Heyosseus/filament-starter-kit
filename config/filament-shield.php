...
return [
    ...
    */
    ...
    'permissions' => [
        ...
        /*
         * Custom permission keys below are used exactly as written rather than
         * being reformatted, so a permission referenced from a gate or a policy
         * reads the same in code as it does in the database.
         */
    ...
    */
    ...
    'custom_permissions' => [
        // Guards the Pulse dashboard, which lives outside Filament and so gets
        // no permission generated for it. See App\Providers\PulseServiceProvider.
